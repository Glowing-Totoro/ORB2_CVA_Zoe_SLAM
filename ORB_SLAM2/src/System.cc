        ...
        mbDeactivateLocalizationMode(false)
{
    ...
    // read setting
    int estInteval = fsSettings["estInteval"];
    ...
    mpTracker = new Tracking(this, mpVocabulary, mpFrameDrawer, mpMapDrawer,
                             mpMap,mpPointCloudMapping, mpKeyFrameDatabase, strSettingsFile, mSensor, estInteval);
...
cv::Mat System::TrackMonocular(const cv::Mat &im, const double &timestamp,const std::string &imagePath)
{
    if(mSensor!=MONOCULAR)
    {
    ...
    cv::Mat Tcw = mpTracker->GrabImageMonocular(im,timestamp,imagePath);
