...
def main(args: argparse.Namespace):
    ...
    dataset = MVSDataset(
        ...
        tuples_default_frame_num=10,
        tuples_default_frame_dist=2,
    ...
    try:
        with torch.no_grad():
            ...
            for batch_idx, batch in enumerate(tqdm(loader)):
                ...
                # print("new"+num_processed+"photos have finished")
    ...
    if len(images) > 0:
        ...
        cv2.imwrite("/home/yu/dataset/om2/0/g/depths/depth" + '.png', image)
    print("image selected have saved")
    ...
    print("output have saved to file")
    print("--------------")
    print("eval over!")
